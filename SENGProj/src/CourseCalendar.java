...
public class CourseCalendar extends JPanel {
    ...
    public CourseCalendar(JPanel panel) {
        ...
        selectProgLabel.setForeground(new Color(255,255,255));
        ...
        txtrEnterCourses.setBackground(new Color(255,255,255));
        ...
        lblRequiredCourses.setForeground(new Color(255,255,255));
        ...
        lblSelectedCourse.setForeground(new Color(255,255,255));
        ...
        txtrNotexx.setForeground(new Color(255,255,255));
